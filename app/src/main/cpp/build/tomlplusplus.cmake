add_library("tomlplusplus" STATIC
"xenia/third_party/tomlplusplus/include/toml++/toml.hpp"
)
if(CMAKE_BUILD_TYPE STREQUAL Checked)
  set_target_properties("tomlplusplus" PROPERTIES
    OUTPUT_NAME "tomlplusplus"
  ...
  target_include_directories("tomlplusplus" PRIVATE
    xenia
    xenia/src
    xenia/third_party
  )
  target_compile_definitions("tomlplusplus" PRIVATE
    _UNICODE
    UNICODE
    USE_CPP17
    _LIB
  ...
  target_link_libraries("tomlplusplus"
    android
    dl
    log
  )
  target_compile_options("tomlplusplus" PRIVATE
