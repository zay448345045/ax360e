...
"xenia/src/xenia/config.cc"
"xenia/src/xenia/config.h"
"xenia/src/xenia/emulator.cc"
"xenia/src/xenia/emulator.h"
"xenia/src/xenia/memory.cc"
"xenia/src/xenia/memory.h"
"xenia/src/xenia/xbox.h"
)
if(CMAKE_BUILD_TYPE STREQUAL Checked)
  add_dependencies("xenia-core"
    "fmt"
    "xenia-base"
  )
  set_target_properties("xenia-core" PROPERTIES
    OUTPUT_NAME "xenia-core"
  ...
  target_include_directories("xenia-core" PRIVATE
    xenia
    xenia/src
    xenia/third_party
  )
  target_compile_definitions("xenia-core" PRIVATE
    _UNICODE
    UNICODE
    USE_CPP17
    _LIB
  ...
  target_link_libraries("xenia-core"
    fmt
    xenia-base
    android
    dl
  ...
  target_compile_options("xenia-core" PRIVATE
