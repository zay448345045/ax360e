...
"xenia/src/xenia/debug/ui/debug_window.cc"
"xenia/src/xenia/debug/ui/debug_window.h"
)
if(CMAKE_BUILD_TYPE STREQUAL Checked)
  add_dependencies("xenia-debug-ui"
    "imgui"
    "xenia-base"
    "xenia-cpu"
    "xenia-ui"
  )
  set_target_properties("xenia-debug-ui" PROPERTIES
    OUTPUT_NAME "xenia-debug-ui"
  ...
  target_include_directories("xenia-debug-ui" PRIVATE
    xenia
    xenia/src
    xenia/third_party
  )
  target_compile_definitions("xenia-debug-ui" PRIVATE
    _UNICODE
    UNICODE
    USE_CPP17
    _LIB
  ...
  target_link_libraries("xenia-debug-ui"
    imgui
    xenia-base
    xenia-cpu
    xenia-ui
  ...
  target_compile_options("xenia-debug-ui" PRIVATE
