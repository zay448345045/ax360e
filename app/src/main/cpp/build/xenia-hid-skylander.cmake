...
"xenia/src/xenia/hid/skylander/skylander_emulated.cc"
"xenia/src/xenia/hid/skylander/skylander_emulated.h"
"xenia/src/xenia/hid/skylander/skylander_portal.cc"
"xenia/src/xenia/hid/skylander/skylander_portal.h"
)
if(CMAKE_BUILD_TYPE STREQUAL Checked)
  set_target_properties("xenia-hid-skylander" PROPERTIES
    OUTPUT_NAME "xenia-hid-skylander"
  ...
  target_include_directories("xenia-hid-skylander" PRIVATE
    xenia
    xenia/src
    xenia/third_party
  )
  target_compile_definitions("xenia-hid-skylander" PRIVATE
    _UNICODE
    UNICODE
    USE_CPP17
    _LIB
  ...
  target_link_libraries("xenia-hid-skylander"
    android
    dl
    log
  )
  target_compile_options("xenia-hid-skylander" PRIVATE
