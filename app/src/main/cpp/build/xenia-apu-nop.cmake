...
"xenia/src/xenia/apu/nop/nop_audio_system.cc"
"xenia/src/xenia/apu/nop/nop_audio_system.h"
)
if(CMAKE_BUILD_TYPE STREQUAL Checked)
  add_dependencies("xenia-apu-nop"
    "xenia-base"
    "xenia-apu"
  )
  set_target_properties("xenia-apu-nop" PROPERTIES
    OUTPUT_NAME "xenia-apu-nop"
  ...
  target_include_directories("xenia-apu-nop" PRIVATE
    xenia
    xenia/src
    xenia/third_party
  )
  target_compile_definitions("xenia-apu-nop" PRIVATE
    _UNICODE
    UNICODE
    USE_CPP17
    _LIB
  ...
  target_link_libraries("xenia-apu-nop"
    xenia-base
    xenia-apu
    android
    dl
  ...
  target_compile_options("xenia-apu-nop" PRIVATE
