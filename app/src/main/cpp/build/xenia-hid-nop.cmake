...
"xenia/src/xenia/hid/nop/nop_hid.cc"
"xenia/src/xenia/hid/nop/nop_hid.h"
"xenia/src/xenia/hid/nop/nop_input_driver.cc"
"xenia/src/xenia/hid/nop/nop_input_driver.h"
)
if(CMAKE_BUILD_TYPE STREQUAL Checked)
  add_dependencies("xenia-hid-nop"
    "xenia-base"
    "xenia-hid"
  )
  set_target_properties("xenia-hid-nop" PROPERTIES
    OUTPUT_NAME "xenia-hid-nop"
  ...
  target_include_directories("xenia-hid-nop" PRIVATE
    xenia
    xenia/src
    xenia/third_party
  )
  target_compile_definitions("xenia-hid-nop" PRIVATE
    _UNICODE
    UNICODE
    USE_CPP17
    _LIB
  ...
  target_link_libraries("xenia-hid-nop"
    xenia-base
    xenia-hid
    android
    dl
  ...
  target_compile_options("xenia-hid-nop" PRIVATE
