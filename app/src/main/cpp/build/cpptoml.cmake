add_library("cpptoml" STATIC
"xenia/third_party/cpptoml/include/cpptoml.h"
)
if(CMAKE_BUILD_TYPE STREQUAL Android-ARM64-Checked)
  ...
  target_include_directories("cpptoml" PRIVATE
          xenia/third_party
  )
  target_compile_definitions("cpptoml" PRIVATE
    _UNICODE
    UNICODE
    _LIB
    DEBUG
  )
  target_link_libraries("cpptoml"
    android
    dl
    log
    ntdll
  ...
  set_property(TARGET "cpptoml" PROPERTY LINK_FLAGS ${_TARGET_LINK_FLAGS})
  unset(_TARGET_LINK_FLAGS)
  target_compile_options("cpptoml" PRIVATE
