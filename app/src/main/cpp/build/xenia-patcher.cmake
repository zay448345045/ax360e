add_library("xenia-patcher" STATIC
        "xenia/src/xenia/patcher/patch_db.cc"
"xenia/src/xenia/patcher/patcher.cc"
"xenia/src/xenia/patcher/patcher.h"
"xenia/src/xenia/patcher/plugin_loader.cc"
"xenia/src/xenia/patcher/plugin_loader.h"
)
if(CMAKE_BUILD_TYPE STREQUAL Checked)
  add_dependencies("xenia-patcher"
    "xenia-base"
  )
  set_target_properties("xenia-patcher" PROPERTIES
    OUTPUT_NAME "xenia-patcher"
  ...
  target_include_directories("xenia-patcher" PRIVATE
    xenia
    xenia/src
    xenia/third_party
  )
  target_compile_definitions("xenia-patcher" PRIVATE
    _UNICODE
    UNICODE
    USE_CPP17
    _LIB
  ...
  target_link_libraries("xenia-patcher"
    xenia-base
    android
    dl
    log
  )
  target_compile_options("xenia-patcher" PRIVATE
