add_library("cxxopts" STATIC
"xenia/third_party/cxxopts/include/cxxopts.hpp"
)
if(CMAKE_BUILD_TYPE STREQUAL Android-ARM64-Checked)
  ...
  target_include_directories("cxxopts" PRIVATE
    xenia
    xenia/src
    xenia/third_party
  )
  target_compile_definitions("cxxopts" PRIVATE
    _UNICODE
    UNICODE
    _LIB
    DEBUG
  ...
  set_property(TARGET "cxxopts" PROPERTY LINK_FLAGS ${_TARGET_LINK_FLAGS})
  unset(_TARGET_LINK_FLAGS)
  target_compile_options("cxxopts" PRIVATE
