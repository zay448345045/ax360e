...
void TraceContextLoadF64(void* raw_context, uint64_t offset, float64x2_t value);
void TraceContextLoadV128(void* raw_context, uint64_t offset, float32x4_t value);
...
void TraceContextStoreF32(void* raw_context, uint64_t offset, float32x4_t value);
void TraceContextStoreF64(void* raw_context, uint64_t offset, float64x2_t value);
void TraceContextStoreV128(void* raw_context, uint64_t offset, float32x4_t value);
...
void TraceMemoryLoadV128(void* raw_context, uint32_t address, float32x4_t value);
...
void TraceMemoryStoreF32(void* raw_context, uint32_t address, float32x4_t value);
void TraceMemoryStoreF64(void* raw_context, uint32_t address, float64x2_t value);
void TraceMemoryStoreV128(void* raw_context, uint32_t address, float32x4_t value);

void TraceMemset(void* raw_context, uint32_t address, uint8_t value, uint32_t length);
